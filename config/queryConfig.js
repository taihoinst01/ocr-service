...
var batchLearningConfig = {
    ...
    selectBatchLearnMlListTest:
        `SELECT IMGID, COLLABEL, COLVALUE, LOCATION, SID, FILEPATH, ENTRYLABEL
         FROM TBL_BATCH_ML_EXPORT WHERE COLLABEL != 36 AND COLLABEL !=38 AND IMGID IN `,
    ...
    deleteBatchLearnList:
        `UPDATE TBL_BATCH_LEARN_LIST SET STATUS = 'R' WHERE IMGID = :imgId`,
