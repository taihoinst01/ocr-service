...
var fn_search = function () {
    ...
    $.ajax({
        url: '/docUpload/searchDocumentList',
        type: 'post',
        datatype: "json",
        data: JSON.stringify(param),
        contentType: 'application/json; charset=UTF-8',
...
var fn_search_dtl = function (docNum) {
    ...
    $.ajax({
        url: '/docUpload/selectOcrFileDtl',
        type: 'post',
        datatype: "json",
        data: JSON.stringify(param),
        contentType: 'application/json; charset=UTF-8',
...
var fn_search_dtl_old = function (seqNum, docNum) {
    ...
    var appendHtml = "";
    $.ajax({
        url: '/docUpload/searchDocumentDtlList',
        type: 'post',
        datatype: "json",
        data: JSON.stringify(param),
        contentType: 'application/json; charset=UTF-8',
...
var fn_search_image = function (imgId) {
    ...
    var appendHtml = "";
    $.ajax({
        url: '/docUpload/searchDocumentImageList',
        type: 'post',
        datatype: "json",
        data: JSON.stringify(param),
        contentType: 'application/json; charset=UTF-8',
    ...
    $("#btn_pop_user_choice").click(function () {
        ...
        if (choiceCnt == 0) {
            ...
            if ($('#scanApproval').val() == 'Y') {
                ...
                $.ajax({
                    url: '/docUpload/sendApprovalDocument',
                    type: 'post',
                    datatype: "json",
                    data: JSON.stringify({
