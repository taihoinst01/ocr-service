        ...
        if (docTopType == "2") {
            ...
            for (var i = 0; i < imgId.length; i++) {
                ...
                worksheet.addRow([
                    ...
                    excelObj.col21, excelObj.col22, excelObj.col23, excelObj.col24, "테스트", excelObj.col25, excelObj.col26,
                    ...
                    excelObj.col47, "테스트", excelObj.col48, excelObj.col49, excelObj.col50, excelObj.col51,
                    ...
                    excelObj.col72, "테스트", excelObj.col73, excelObj.col74, excelObj.col75, excelObj.col76,
                    ...
                    excelObj.col97, "테스트", excelObj.col98, excelObj.col99, excelObj.col100, excelObj.col101, 
                    ...
                    excelObj.col122, "테스트", excelObj.col123, excelObj.col124, excelObj.col125, excelObj.col126,
                    "테스트", excelObj.col127, excelObj.col128, excelObj.col129, excelObj.col130, excelObj.col131,
